...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AvatarData", function() { return AvatarData; });
...
class AvatarData {
    constructor({ url, tracker, enableRotate = false, enableZoom = false, loading = true, }) {
        this.update({ url, tracker, enableRotate, enableZoom, loading });
    }
    update({ url, tracker, enableRotate, enableZoom, loading, }) {
        this.url = url;
...
class AppComponent {
    constructor() {
        this.men = new AvatarData({ url: src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].menURL, tracker: 'cursor' });
        this.women = new AvatarData({ url: src_environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].womenURL, tracker: 'cursor' });
    }
    ngOnInit() { }
    onUpdateMen(data) {
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 4, vars: 4, consts: [[1, "men-avatar", 3, "data"], [1, "men-form", 3, "data", "submit"], [1, "women-avatar", 3, "data"], [1, "women-form", 3, "data", "submit"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("submit", function AppComponent_Template_app_avatar_form_submit_1_listener($event) { return ctx.onUpdateMen($event); });
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("submit", function AppComponent_Template_app_avatar_form_submit_3_listener($event) { return ctx.onUpdateWomen($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    } if (rf & 2) {
...
/* harmony import */ var _components_spinner_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/spinner.component */ "./src/app/components/spinner.component.ts");
/* harmony import */ var _components_avatar_visor_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./components/avatar-visor.component */ "./src/app/components/avatar-visor.component.ts");
/* harmony import */ var _michaelldev_ngx_profile_avatar__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @michaelldev/ngx-profile-avatar */ "./node_modules/@michaelldev/ngx-profile-avatar/fesm2015/michaelldev-ngx-profile-avatar.js");
/* harmony import */ var _components_avatar_form_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/avatar-form.component */ "./src/app/components/avatar-form.component.ts");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_5__["AppComponent"],
        _components_spinner_component__WEBPACK_IMPORTED_MODULE_6__["SpinnerComponent"],
        _components_avatar_visor_component__WEBPACK_IMPORTED_MODULE_7__["AvatarVisorComponent"],
        _components_avatar_form_component__WEBPACK_IMPORTED_MODULE_9__["AvatarFormComponent"]], imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"],
        _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
        _app_routing__WEBPACK_IMPORTED_MODULE_4__["AppRoutingModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"],
        _angular_forms__WEBPACK_IMPORTED_MODULE_3__["ReactiveFormsModule"],
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AppModule, [{
        ...
        args: [{
                declarations: [
                    ...
                    _components_spinner_component__WEBPACK_IMPORTED_MODULE_6__["SpinnerComponent"],
                    _components_avatar_visor_component__WEBPACK_IMPORTED_MODULE_7__["AvatarVisorComponent"],
                    _components_avatar_form_component__WEBPACK_IMPORTED_MODULE_9__["AvatarFormComponent"],
                ],
                imports: [
                    _angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"],
                    _angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AvatarFormComponent", function() { return AvatarFormComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
...
class AvatarFormComponent {
    ...
    onSubmit() {
        ...
        this.change.emit(Object.assign(Object.assign({}, this.formGroup.value), { loading: this.formGroup.get('url').value !== this.data.url }));
    }
}
AvatarFormComponent.ɵfac = function AvatarFormComponent_Factory(t) { return new (t || AvatarFormComponent)(); };
AvatarFormComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AvatarFormComponent, selectors: [["app-avatar-form"]], inputs: { data: "data" }, outputs: { change: "change" }, decls: 34, vars: 1, consts: [[3, "formGroup", "ngSubmit"], [1, "form-item"], ["for", "url", 1, "form-label"], ["type", "url", "id", "url", "formControlName", "url", "placeholder", "Enter your 3d avatar URL generated from ReadyPlayerMe", "required", "true", 1, "form-control"], ["for", "tracker", 1, "form-label"], ["id", "tracker", "formControlName", "tracker", "required", "true", 1, "form-control"], ["value", "cursor"], ["value", "face"], ["for", "rotation", 1, "form-label"], ["id", "rotation", "formControlName", "enableRotate", "required", "true", 1, "form-control"], ["value", "true"], ["value", "false"], ["for", "zoom", 1, "form-label"], ["id", "zoom", "formControlName", "enableZoom", "required", "true", 1, "form-control"], ["type", "submit", 1, "button"]], template: function AvatarFormComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "form", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function AvatarFormComponent_Template_form_ngSubmit_0_listener() { return ctx.onSubmit(); });
...
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AvatarFormComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "AvatarVisorComponent", function() { return AvatarVisorComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _michaelldev_ngx_profile_avatar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @michaelldev/ngx-profile-avatar */ "./node_modules/@michaelldev/ngx-profile-avatar/fesm2015/michaelldev-ngx-profile-avatar.js");
/* harmony import */ var _spinner_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./spinner.component */ "./src/app/components/spinner.component.ts");




class AvatarVisorComponent {
    ngOnInit() {
    }
    ngOnChanges() {
    }
...
AvatarVisorComponent.ɵfac = function AvatarVisorComponent_Factory(t) { return new (t || AvatarVisorComponent)(); };
AvatarVisorComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AvatarVisorComponent, selectors: [["app-avatar-visor"]], inputs: { data: "data" }, features: [_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵNgOnChangesFeature"]], decls: 4, vars: 6, consts: [[1, "avatar-container"], [1, "avatar", 3, "url", "tracker", "enableRotate", "enableZoom", "loading"], [1, "spinner-container"]], template: function AvatarVisorComponent_Template(rf, ctx) { if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 0);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](1, "ngx-profile-avatar", 1);
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("loading", function AvatarVisorComponent_Template_ngx_profile_avatar_loading_1_listener($event) { return ctx.onLoading($event); });
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementEnd"]();
    ...
    } }, directives: [_michaelldev_ngx_profile_avatar__WEBPACK_IMPORTED_MODULE_1__["NgxProfileAvatarComponent"], _spinner_component__WEBPACK_IMPORTED_MODULE_2__["SpinnerComponent"]], styles: ["div.avatar-container[_ngcontent-%COMP%] {\n      position: relative;\n      width: 100%;\n      height: 100%;\n      border-right: 1px solid var(--gray-600);\n    }\n\n    .avatar[_ngcontent-%COMP%] {\n      display: flex;\n      flex-grow: 1;\n      width: 100%;\n      height: 100%;\n    }\n\n    div.spinner-container[_ngcontent-%COMP%] {\n      position: absolute;\n      inset: 0;\n      display: flex;\n      justify-content: center;\n      align-items: center;\n      visibility: visible;\n      visibility: visible;\n      transition: visibility 1s ease;\n    }\n\n    div.hide[_ngcontent-%COMP%] {\n      visibility: hidden;\n    }"] });
/*@__PURE__*/ (function () { _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](AvatarVisorComponent, [{
        type: _angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"],
        args: [{
...
module.exports = __webpack_require__(/*! C:\Users\fmich\OneDrive\Documentos\GitHub\ngx-profile-avatar\ngx-profile-avatar-app\src\main.ts */"./src/main.ts");
